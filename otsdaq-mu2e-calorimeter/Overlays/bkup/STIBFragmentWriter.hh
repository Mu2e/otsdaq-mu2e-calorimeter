...
class ots::STIBFragmentWriter : public ots::STIBFragment {
  public:
	...
	void set_hdr_bunch_counter(Header::counter_t counter) { header_()->bunch_counter = counter; }

	void set_hdr_trigger_counter(Header::counter_t counter) { header_()->trigger_counter = counter; }

	void set_hdr_trigger_input0(Header::counter_t input) { header_()->trigger_input0 = input; }

	void set_hdr_trigger_input1(Header::counter_t input) { header_()->trigger_input1 = input; }
