...
int Calo_generate_txt(const std::string& inputFileName, const std::string& outputName, int option) {
    ...
    if (option == 1) { // Two events
        outFile << "Calo_" + inputFileName + " ewt, ch1_t0, ch1_dt-10us, ch11_t0, ch11_dt-10us, ch20_t0, ch20_dt-10us, ch41_t0, ch41_dt-10us, ch51_t0, ch51_dt-10us, ch60_t0, ch60_dt-10us" << std::endl;
